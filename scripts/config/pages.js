module.exports = [
  ...
  [
    ...
    "app/cashier/account_transfer",
    "default",
    "Transfer Between Accounts",
  ],
  ["cashier/dp2p", "app/cashier/dp2p", "default", "P2P"],
  [
    "cashier/epg_forwardws",
    "app/cashier/deposit_withdraw",
    "default",
    "Cashier",
  ],
  ...
  [
    ...
    "app/cashier/payment_agent_list",
    "default",
    "Payment Agent Deposit",
  ],
  [
    "cashier/payment_methods",
    "app/cashier/payment_methods",
    "default",
    "Payment Methods",
  ],
  [
    "cashier/session_expired",
    "app/cashier/session_expired",
    null,
    "Cashier session expired",
  ],
  [
    "cashier/top_up_virtualws",
    "app/user/top_up_virtual/top_up_virtual",
    "default",
    "Top Up Demo Account",
  ],
  ...
  [
    ...
    "app/cashier/paymentagent_transfer",
    "default",
    "Payment Agent Transfer",
  ],
  [
    "paymentagent/withdrawws",
    "app/cashier/paymentagent_withdraw",
    "default",
  ...
  [
    ...
    "app/new_account/financial",
    "default",
    "Financial Account Opening",
  ],
  [
    "new_account/realws",
    "app/new_account/real",
    "default",
    "Real Money Account Opening",
  ],
  [
    "new_account/real_account",
    "app/new_account/real_account",
    "default",
    "Real Account Opening",
  ],
  [
    "new_account/virtualws",
    "app/new_account/virtual",
    "default",
    "Create New Demo Account",
  ],
  [
    "new_account/welcome",
    "app/new_account/welcome_page",
    "default",
    "Welcome to Binary.com",
  ],
  [
    "new_account/welcome_onboarding",
    "app/new_account/welcome_onboarding",
    "default",
    "Welcome to Binary.com",
  ],
  ...
  [
    ...
    "app/resources/asset_index",
    "full_width",
    "Asset Index",
  ],
  [
    "resources/market_timesws",
    "app/resources/trading_times",
    "default",
    "Trading Times",
  ],
  [
    "resources/economic_calendar",
    "app/resources/economic_calendar",
    "default",
    "Economic Calendar",
  ],
  ...
  [
    "user/reality_check_frequency",
    "app/user/reality_check/frequency",
    "default",
    "Reality Check",
  ],
  [
    "user/reality_check_summary",
    "app/user/reality_check/summary",
    "default",
    "Reality Check",
  ],
  [
  ...
  [
    "user/trading_reset_passwordws",
    "app/user/trading_reset_password",
    "default",
    "Change MT5 Password",
  ],
  ["user/securityws", "app/user/security", "default", "Security"],
  [
    "user/security/closure",
    "app/user/security/account_closure",
    "default",
    "Account Closure",
  ],
  [
    "user/security/api_tokenws",
    "app/user/security/api_token",
    "default",
    "API Token",
  ],
  [
    "user/security/authorised_appsws",
    "app/user/security/authorised_apps",
    "default",
    "Authorised Applications",
  ],
  [
    "user/security/change_passwordws",
    "app/user/security/change_password",
    "default",
    "Change Password",
  ],
  [
    "user/security/iphistoryws",
    "app/user/security/iphistory",
    "default",
    "Login History",
  ],
  [
    "user/security/limitsws",
    "app/user/security/limits",
    "default",
    "Account Limits",
  ],
  [
    "user/security/self_exclusionws",
    "app/user/security/self_exclusion",
    "default",
    "Self Exclusion",
  ],
  [
    "user/security/two_factor_authentication",
    "app/user/security/two_factor_authentication",
    "default",
    "Two-Factor Authentication",
  ],
  [
    "user/security/cloudflare_dns",
    "app/user/security/cloudflare_dns",
    "default",
    "Binary.com recommends 1.1.1.1",
  ],
  ...
  [
    ...
    "app/user/settings/financial_assessment",
    "default",
    "Financial Assessment",
  ],
  [
    "user/settings/detailsws",
    "app/user/settings/personal_details",
    "default",
    "Personal Details",
  ],
  [
    "user/settings/professional",
    "app/user/settings/professional",
    "default",
    "Professional Client",
  ],
  ...
  [
    "user/top_up_virtual_pop_up",
    "app/user/top_up_virtual/pop_up",
    "default",
    "Top Up Demo Account",
  ],
  [
    "user/tnc_approvalws",
    "app/user/tnc_approval",
    "default",
    "Terms and Conditions Approval",
  ],
  [
    "user/video-facility",
    "app/user/video_facility",
    "default",
    "Video Room Facility",
  ],
  ...
  [
    ...
    "static/home",
    "full_width",
    "Online trading platform for binary options on forex, stock indices, commodities and Synthetic indices",
  ],
  ...
  [
    "binary-in-numbers",
    "static/about/binary_in_numbers",
    "default",
    "Binary.com in Numbers",
  ],
  ["careers", "static/about/careers", "full_width", "Careers"],
  [
    "careers/privacy-policy",
    "static/about/job_applicant_policy",
    "full_width",
  ...
  [
    "group-history",
    "static/about/group_history",
    "full_width",
    "Group History",
  ],
  [
    "open-positions",
    "static/about/job_descriptions",
    "full_width",
    "Open Positions",
  ],
  [
    "open-positions/job-details",
    "static/about/job_details",
    "full_width",
    "Job Details",
  ],
  ...
  [
    ...
    "static/partners/open_source_projects",
    "full_width",
    "Open-Source Projects",
  ],
  ...
  [
    "payment-agent",
    "static/partners/payment_agent",
    "full_width",
    "Payment Agents",
  ],
  [
    "security-testing",
    "static/partners/security_testing",
    "full_width",
    "Security Testing",
  ],
  ...
  [
    ...
    "static/get_started/binary_options",
    "default",
    "Binary Options",
  ],
  ["get-started/cfds", "static/get_started/cfds", "default", "CFDs"],
  [
    "get-started/cryptocurrencies",
    "static/get_started/cryptocurrencies",
    "default",
    "Cryptocurrencies",
  ],
  ...
  [
    "metatrader/download",
    "static/metatrader/download",
    "default",
    "Start Trading with MetaTrader 5",
  ],
  [
    "metatrader/how-to-trade-mt5",
    "static/metatrader/how_to_trade_mt5",
    "default",
    "How to Trade in MetaTrader 5",
  ],
  [
    "metatrader/types-of-accounts",
    "static/metatrader/types_of_accounts",
    "default",
  ...
  [
    "graduates",
    "landing_pages/graduate_program",
    null,
    "Binary.com Graduate Program",
    "NOT-en",
  ],
